...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    parseSelectOptions: function parseSelectOptions(selectOptions) {
      ...
      if (typeof selectOptions === 'string') {
        try {
          var decoded = JSON.parse(selectOptions);
    ...
    convertNameToSlug: function convertNameToSlug(name) {
      ...
      this.timer = setTimeout(function () {
        ...
        _this.checkAttributeSlugUnique(slug);
      }, 300);
    },
    checkAttributeSlugUnique: function checkAttributeSlugUnique(slug) {
      var _this2 = this;
      var params = {
        slug: slug
      };
      ...
      axios.post('/admin/attribute/fetch/attribute-slug', params).then(function (response) {
        _this2.attribute.slug = response.data.slug;
      })["catch"](function (err) {
        console.error(err);
      });
    },
    saveData: function saveData() {
      ...
      axios[this.method]("".concat(this.axios_url, "?locale=").concat(this.locale), params).then(function (response) {
        ...
        _this3.$refs.formFields.validationErrors = "";
        window.location.href = "/" + response.data.redirect_url;
      })["catch"](function (err) {
        var errors = _.cloneDeep(err.response.data.errors || {});
        ...
        _this3.$refs.formFields.validationErrors = errors;
        new Noty({
          type: "error",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    checkHasRange: function checkHasRange() {
      var selectedType = this.$parent.attribute.type;
    ...
    addOptionRow: function addOptionRow() {
      this.$parent.attribute.select_options.push({
        label: '',
        slug: ''
      });
    },
    removeOptionRow: function removeOptionRow(index) {
      this.$parent.attribute.select_options.splice(index, 1);
    },
    syncOptionSlug: function syncOptionSlug(index) {
      var option = this.$parent.attribute.select_options[index];
      option.slug = this.makeSlug(option.label);
    },
    makeSlug: function makeSlug(value) {
      return (value || '').trim().toLowerCase().replace(/-/g, ' ').replace(/[^\w ]+/g, '').replace(/ +/g, '-');
    },
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("Display Name")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      input: [function ($event) {
        ...
        _vm.$parent.convertNameToSlug(_vm.$parent.attribute.name);
      }]
    }
    ...
    on: {
      input: [function ($event) {
        ...
        return _vm.removeError("slug");
      }]
    }
  }), _vm._v(" "), _vm.validationErrors.slug ? _c("small", {
    staticClass: "text-danger mt-3"
  }, [_vm._v(_vm._s(_vm.validationErrors.slug[0]))]) : _vm._e()]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12"
    ...
    staticClass: "text-danger mt-3"
  }, [_vm._v(_vm._s(_vm.validationErrors.type[0]))]) : _vm._e()]), _vm._v(" "), _vm.$parent.attribute.type === "select" ? _c("div", {
    staticClass: "form-group col-sm-12"
  }, [_c("label", [_vm._v("Select Options")]), _vm._v(" "), _c("div", {
    staticClass: "table-responsive"
  }, [_c("table", {
    staticClass: "table table-sm table-bordered mb-2"
  }, [_vm._m(1), _vm._v(" "), _c("tbody", [_vm._l(_vm.$parent.attribute.select_options, function (option, index) {
    return _c("tr", {
      key: "opt-".concat(index)
    }, [_c("td", [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
      ...
      on: {
        input: [function ($event) {
          if ($event.target.composing) return;
          _vm.$set(option, "label", $event.target.value);
        }, function ($event) {
          return _vm.syncOptionSlug(index);
        }]
      }
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(option, "slug", $event.target.value);
        }
      }
    })]), _vm._v(" "), _c("td", {
      ...
      on: {
        click: function click($event) {
          return _vm.removeOptionRow(index);
        }
      }
    }, [_c("i", {
      staticClass: "la la-trash"
    })])])]);
  }), _vm._v(" "), !_vm.$parent.attribute.select_options.length ? _c("tr", [_c("td", {
    staticClass: "text-muted text-center",
    attrs: {
      colspan: "3"
    }
  }, [_vm._v("No options added.")])]) : _vm._e()], 2)])]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-outline-primary btn-sm",
    attrs: {
      type: "button"
    },
    on: {
      click: _vm.addOptionRow
    }
  }, [_vm._v("Add Option")])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12"
  }, [_c("label", {
    "class": {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$parent.attribute.is_required,
      expression: "$parent.attribute.is_required"
    }],
    attrs: {
      id: "is_required",
      type: "checkbox"
    ...
    domProps: {
      checked: Array.isArray(_vm.$parent.attribute.is_required) ? _vm._i(_vm.$parent.attribute.is_required, null) > -1 : _vm.$parent.attribute.is_required
    },
    on: {
      change: function change($event) {
        var $$a = _vm.$parent.attribute.is_required,
          $$el = $event.target,
          $$c = $$el.checked ? true : false;
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.$parent.attribute, "is_required", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.$parent.attribute, "is_required", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.$parent.attribute, "is_required", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("label", {
  ...
  }, [_vm._v("Is Required")])])]), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12"
  }, [_c("div", {
    staticClass: "checkbox"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$parent.attribute.is_updated,
      expression: "$parent.attribute.is_updated"
    }],
    attrs: {
      id: "is_updated",
      type: "checkbox"
    ...
    domProps: {
      checked: Array.isArray(_vm.$parent.attribute.is_updated) ? _vm._i(_vm.$parent.attribute.is_updated, null) > -1 : _vm.$parent.attribute.is_updated
    },
    on: {
      change: function change($event) {
        var $$a = _vm.$parent.attribute.is_updated,
          $$el = $event.target,
          $$c = $$el.checked ? true : false;
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.$parent.attribute, "is_updated", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.$parent.attribute, "is_updated", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.$parent.attribute, "is_updated", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("label", {
  ...
  }, [_vm._v("Is Updated")])])]), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12"
  }, [_c("div", {
    staticClass: "checkbox"
  }, [_c("input", {
...
var staticRenderFns = [function () {
  ...
  var _vm = this,
    _c = _vm._self._c;
  return _c("thead", [_c("tr", [_c("th", [_vm._v("Label")]), _vm._v(" "), _c("th", [_vm._v("Slug")]), _vm._v(" "), _c("th", {
