...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  props: ['class_name', 'url', 'active_tab', 'method', 'axios_url', 'query_string', 'customer_group_pricing_type', 'customer_group_data', 'categories', 'catalog_categories', 'users', 'save_action'],
  data: function data() {
    return {
      customer_group: {
        id: '',
  ...
  methods: {
    initEdit: function initEdit() {
      var _customer_group_data$, _customer_group_data$2, _customer_group_data$3;
      ...
      this.customer_group = {
        ...
        catalog: (_customer_group_data$ = customer_group_data.catalog) !== null && _customer_group_data$ !== void 0 ? _customer_group_data$ : null,
        customers: (_customer_group_data$2 = customer_group_data.customers) !== null && _customer_group_data$2 !== void 0 ? _customer_group_data$2 : [],
        users: (_customer_group_data$3 = customer_group_data.users) !== null && _customer_group_data$3 !== void 0 ? _customer_group_data$3 : []
      };
    ...
    saveData: function saveData(actionType) {
      ...
      params.category_id = (_params$catalog$id = (_params$catalog = params.catalog) === null || _params$catalog === void 0 ? void 0 : _params$catalog.id) !== null && _params$catalog$id !== void 0 ? _params$catalog$id : null;
      delete params.catalog;
      params.users = ((_params$users = params.users) !== null && _params$users !== void 0 ? _params$users : []).map(function (user) {
        var _user$id;
        return (_user$id = user === null || user === void 0 ? void 0 : user.id) !== null && _user$id !== void 0 ? _user$id : user;
      });
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "text-danger mt-3"
  }, [_vm._v(_vm._s(_vm.$parent.validationErrors.group_pricing_type[0]))]) : _vm._e()], 2), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12",
    "class": {
      "text-danger": _vm.$parent.validationErrors.category_id
    }
  }, [_c("label", [_vm._v("\n                Catalog\n            ")]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.$parent.catalogCategories,
      multiple: false,
    ...
    model: {
      value: _vm.$parent.customer_group.catalog,
      callback: function callback($$v) {
        _vm.$set(_vm.$parent.customer_group, "catalog", $$v);
      },
      expression: "$parent.customer_group.catalog"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "text-muted d-block mt-2"
  }, [_vm._v("\n                Optional. Leave empty if this customer group should not belong to a catalog.\n            ")]), _vm._v(" "), _vm.$parent.validationErrors.category_id ? _c("small", {
    staticClass: "text-danger mt-2"
  }, [_vm._v(_vm._s(_vm.$parent.validationErrors.category_id[0]))]) : _vm._e()], 1), _vm._v(" "), _c("div", {
    staticClass: "form-group col-sm-12",
    "class": {
      "text-danger": _vm.$parent.validationErrors.users
    }
  }, [_c("label", [_vm._v("\n                Assigned Users\n            ")]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.$parent.availableUsers,
      multiple: true,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref3) {
        ...
        return [_c("div", {
          staticClass: "d-flex flex-column"
        }, [_c("span", [_vm._v(_vm._s(option.name))]), _vm._v(" "), _c("small", {
    ...
    model: {
      value: _vm.$parent.customer_group.users,
      callback: function callback($$v) {
        _vm.$set(_vm.$parent.customer_group, "users", $$v);
      },
      expression: "$parent.customer_group.users"
    }
  }), _vm._v(" "), _vm.$parent.validationErrors.users ? _c("small", {
    staticClass: "text-danger mt-3"
  }, [_vm._v(_vm._s(_vm.$parent.validationErrors.users[0]))]) : _vm._e()], 1), _vm._v(" "), _vm.$parent.customer_group.group_pricing_type === "rules-based-pricing" ? _c("div", {
