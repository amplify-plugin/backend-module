<template>
    <div class="fm d-flex flex-column rounded"
        ...
        <div class="fm-body">
            ...
            <template v-else-if="windowsConfig === 2">
                <folder-tree class="col-12 col-md-3"/>
                <left-manager class="col-12 col-md-9" manager="left"/>
                <div :class="{'d-md-none close-menu-sidebar':true, 'open': showMenu}" @click="handleShowMenu">
