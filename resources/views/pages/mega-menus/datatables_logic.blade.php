        ...
        dataTableConfiguration: {
            ...
            */
            ...
            language: {
                ...
                "processing": "<img src='{{ assets_image('packages/backpack/crud/img/ajax-loader.gif') }}' alt='{{ trans('backpack::crud.processing') }}'>",
                "search": "_INPUT_",
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        var crudTableResetButton = '<a href="{{url($crud->route)}}?menuId={{ $crud->menu->id }}" class="ml-1" id="crudTable_reset_button">{{ trans('backpack::crud.reset') }}</a>';
