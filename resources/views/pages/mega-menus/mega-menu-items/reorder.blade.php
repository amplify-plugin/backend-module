...
@php
    abort_if(!request()->menuId, 500);
    $menu_url           = url($crud->route . '?menuId=' . request('menuId') . '&group_id=' . request('group_id'));
    $reorder_url        = url($crud->route . '/reorder' . '?menuId=' . request('menuId') . '&group_id=' . request('group_id'));
