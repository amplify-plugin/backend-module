                    ...
                    @if ( $crud->buttons()->where('stack', 'top')->count() ||  $crud->exportButtons())
                        <div class="d-print-none {{ $crud->hasAccess('create')?'with-border':'' }}">
                            ...
                            @if ($crud->get('reorder.enabled') && $crud->hasAccess('reorder'))
                                <a id="render-btn-loader" onclick="renderButtonLoader(event)" href="{{ url($crud->route.'/reorder') }}" class="btn btn-outline-primary" data-style="zoom-in"><span class="ladda-label"><i class="la la-arrows"></i> {{ trans('backpack::crud.reorder') }} {{ $crud->entity_name_plural }}</span></a>
                            @endif
                        </div>
                    @endif
                </div>
