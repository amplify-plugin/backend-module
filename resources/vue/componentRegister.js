...
Vue.component('SortableList', () => import('./views/components/sortable-list/SortableList.vue'));
Vue.component('SortableHandle', () => import('./views/components/sortable-list/SortableHandle.vue'));
