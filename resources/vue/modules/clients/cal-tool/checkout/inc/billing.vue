                ...
                <div class="interactive-credit-card">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input id="expiry" class="form-control" type="text" name="expiry" placeholder="MM/YY*" />
                            <span class="invalid-feedback"></span>
                        </div>

                        <div class="form-group col-sm-6">
                            <label for="cvc" class="sr-only">CVC</label>
                            <input id="cvc" class="form-control" type="text" name="cvc" placeholder="CVC*" />
                            <span class="invalid-feedback"></span>
                        </div>

                        <div class="form-group col-sm-12">
                            <label for="full-name" class="sr-only">Full Name</label>
                            <input id="full-name" class="form-control billing-info" type="text" name="name" placeholder="Full Name*" />
                            <span class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="row" v-show="$parent.checkout_payload.billing_address === 'other-address'">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    />
                    <label for="bill-to-address2" class="sr-only">bill-to-address 2</label>
                    <input
                        class="form-control my-1 billing-info"
                    ...
                    />
                    <label for="bill-to-address3" class="sr-only">bill-to-address 3</label>
                    <input
                        class="form-control my-1 billing-info"
