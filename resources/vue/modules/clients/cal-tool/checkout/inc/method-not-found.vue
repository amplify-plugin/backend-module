<template>
    <div class="row justify-content-center">
        <div class="col-7 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 60 500 420">
                ...
                <g id="freepik--Boxes--inject-64">
                    <path
                        ...
                        style="fill: #263238"
                    ></path>
                    <rect x="230.75" y="226.6" width="140.21" height="108.14" style="fill: #ebebeb"></rect>
                    <polygon
                    ...
                    <rect x="213.89" y="334.74" width="161.21" height="124.34" style="fill: #ebebeb"></rect>
                    <rect
                        x="213.89"
                        y="334.74"
                        width="161.21"
            ...
            <h3 class="text-center">Shipping method not available!</h3>
