<template>
    <section class="checkout checkout-step" :class="[`checkout-${stepId}`, { active: isActive }]" :data-parent="`#${stepId}`">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="credit_card_token" id="credit-card-token" v-model="$parent.checkout_payload.credit_card_token">
                ...
                <div class="interactive-credit-card">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <input class="form-control billing-info" type="text" name="number" placeholder="Card Number*" />
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="billing_address" id="billing-checkout-address" v-model="$parent.checkout_payload.billing_address">
        ...
        <div class="row" v-show="$parent.checkout_payload.billing_address == 'other-address'">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input class="form-control my-1 billing-info" placeholder="Address Line 1" type="text" id="bill-to-address1" v-model="$parent.checkout_payload.billing_address1"/>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <select class="form-control billing-info" name="billing_state" type="text" id="bill-to-state" v-model="$parent.checkout_payload.billing_state">
                        <option value="">Select an State</option>
                        <option
                            v-for="(stateName, stateCode) in $parent.states"
                            :key="stateCode"
                            :value="stateCode"
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control billing-info" name="billing_city" type="text" id="bill-to-city" v-model="$parent.checkout_payload.billing_city"/>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control billing-info" name="billing_zip_code" type="text" id="bill-to-zip-code" v-model="$parent.checkout_payload.billing_zip_code"/>
                </div>
            </div>
        </div>
    </section>
