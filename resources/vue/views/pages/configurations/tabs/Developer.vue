      ...
      <div class="toggle-grid">
        <div class="form-group">
          ...
          <small class="text-muted mt-2 d-block">
            ...
            <a :href="`/admin/api-log?group=${easyAskUrl}`" target="_blank">See Current Logs</a>
          </small>
        </div>
        ...
        <div class="form-group">
          ...
          <small class="text-muted mt-2 d-block">
            ...
            <a :href="`/admin/api-log?group=${paymentGatewayUrl}`" target="_blank">See Current Logs</a>
          </small>
        </div>
        ...
        <div class="form-group">
          ...
          <small class="text-muted mt-2 d-block">
            ...
            <a :href="`/admin/api-log?group=${erpAPiUrl}`" target="_blank">See Current Logs</a>
          </small>
        </div>
        ...
        <div class="form-group">
          <p class="text-muted mt-2 d-block mb-0">
            <a href="/admin/env-variable" target="_blank">.ENV Variable Editor <code>(Developer and System Administrator
              Only)</code></a>
          </p>
        </div>
      </div>
