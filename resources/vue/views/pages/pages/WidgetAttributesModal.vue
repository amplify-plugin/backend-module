                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body bg-light">
                        ...
                        <div v-if="!showFileManagerIFrame">
                            ...
                            <div v-if="showAttributes">
                                ...
                                >
                                    <label
                                        :for="attribute.name"
                                        v-if="
                                            attribute.type !== 'banner-code' ||
                                            (attribute.type === 'banner-code' && $parent.showBannerCode)
                                        "
                                    >
                                    ...
                                    <div v-if="attribute.type === 'boolean' || attribute.type === 'bool'">
                                        <div class="form-check form-check-inline">
                                            ...
                                            />
                                            <label class="form-check-label" :for="attribute.name + 'true'">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input
                                                class="form-check-input"
                                                ...
                                                v-model="attribute.value"
                                            />
                                            <label class="form-check-label" :for="attribute.name + 'false'">No</label>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="attribute.type === 'select'">
                                        ...
                                        >
                                            ...
                                            <option
                                                v-for="(option, value) in attribute.options"
                                                :value="value"
                                                :key="value"
                                    ...
                                    <div class="d-block" v-if="attribute.type === 'banner-zone'">
                                        <multiselect
                                            :id="attribute.name"
                                            v-model="attribute.value"
                                    ...
                                    <div class="d-block" v-if="attribute.type === 'content-dropdown'">
                                        <multiselect
                                            :id="attribute.name"
                                            v-model="attribute.value"
                                    ...
                                    <div
                                        class="d-block"
                                        v-if="
                                            attribute.type === 'array' && typeof attribute.array_format == 'undefined'
                                        "
                                    >
                                        <div
                                            class="row"
                                    ...
                                    >
                                        <div
                                            class="d-flex bg-secondary my-2 rounded border"
                                            v-for="(item, indexOfvalue) in attribute.value"
                                            :key="indexOfvalue"
                                        >
                                            <div
                                                class="mt-2 mb-3 col-md"
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            title="select file"
                                                            @click="
                                                                showFileManagerIFrame = !showFileManagerIFrame;
                                                                processImagesByType(indexOfAttributes);
                                                                canMultiple = false;
                                                            "
                                                        />
                                                    </label>
                                    ...
                                    <small v-show="typeof attribute.hint != 'undefined'" class="text-muted font-italic">
                                        <span class="font-weight-bold">Hint:</span> {{ attribute.hint }}
                                    </small>
                                </div>
                            </div>

                            <div v-if="showNestedItems" class="border rounded p-3">
                                <h5>
                                    <span class="text">Nested Tags</span>
                                </h5>

                                <div
                                    v-for="(nestedItem, indexOfNestedItems) in widget['@nestedItems']"
                                    class="mb-3"
                                ...
                                >
                                    <fieldset class="form-group border p-3">
                                        ...
                                        <div v-if="nestedItem['@inside']" class="form-row">
                                            <div class="form-group col-12">
                                                <label>
                                                    <strong> Inside text of the tag </strong>
                                                </label>
                                                <input
                                                    type="text"
                                        ...
                                        <div v-if="nestedItem['@attributes'].length > 0">
                                            <div
                                                ...
                                                :key="indexOfAtt"
                                            >
                                                <div class="form-group col-12" v-if="attribute.type === 'boolean'">
                                                    <label>
                                                        <strong>
                                                            {{ makeTitleCase(attribute.name) }}
                                                        </strong>
                            ...
                            <div v-if="!widget['@inside'] && !showAttributes && !showNestedItems" class="form-row">
                                <div class="col-12 text-center">No attributes / nested items found</div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="saveData()" id="saveButton">
                            Generate Widget
                        </button>
                    </div>
                </div>
    ...
    methods: {
        getModal() {
            ...
            this.showNestedItems =
                this.widget['@nestedItems'] !== null ? this.widget['@nestedItems'].length > 0 : false;
        ...
        saveData() {
            axios
                .post(`/admin/page/fetch/convert-object-to-code`, {
        ...
        async configureWidgetData(field, target) {
            await axios
                .get(`/admin/page/get-widget-data/` + field, {
                    headers: {
