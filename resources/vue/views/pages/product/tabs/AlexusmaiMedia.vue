        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <div class="card mb-3">
                        <div class="card-body">
                            <strong class="mb-3 d-block" :class="{'text-danger': $parent.validationErrors.main}">Main
                                Image</strong>
                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="btn-group">
                                        <label
                                            ...
                                            <input id="main-image-browse" type="text"
                                                   ...
                                                   title="select file"
                                                   @click="processImagesByType('main'); getImageBrowseModal(); canMultiple = false; browseMainImage($event)">
                                        </label>
                                        <label
                                        ...
                                        <button class="d-none btn btn-light btn-sm"
                                                data-handle="remove"
                                ...
                                <div class="image w-one-third text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        <div v-else>
                                            <button v-if="$parent.productData.product_image.main"
                                                    class="btn bg-danger rounded-circle p-1 position-absolute e-0 cursor-pointer"
                                                    data-handle="remove"
                                                    style="width: 32px; height: 32px"
                                                    @click="deleteImage('main',$parent.productData.product_image.main)"
                                            ><i class="la la-times"></i></button>
                                            <img @error="$root.getDefaultImage" class="img-thumbnail"
                                                 style="height: 79px;"
                                                 :src="`${$parent.productData.product_image.main ? $parent.productData.product_image.main : placeholder}`"
                                                 alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="form-group">
                    <div class="card mb-3">
                        <div class="card-body">
                            <strong class="mb-3 d-block" :class="{'text-danger': $parent.validationErrors.thumbnail}">Thumbnail</strong>
                            <div class="d-flex justify-content-between">
                                <div class=" mr-3 w-one-third m-auto">
                                    ...
                                    <small v-if="$parent.validationErrors.thumbnail"
                                           class="text-danger mt-3">{{ $parent.validationErrors.thumbnail[0] }}</small>
                                </div>
                                <div class="w-one-third text-center px-3 m-auto">
                                    <div class="btn-group">
                                        <label
                                            ...
                                            <i class="la la-hand-pointer"></i>{{ titles.choose_file }}
                                            <input id="thumb-image-browse" type="text"
                                                   class="form-control d-none file_design"
                                                   title="select file"
                                                   @click="processImagesByType('thumbnail'); getImageBrowseModal(); canMultiple = false; browseThumbImage($event)">
                                        </label>
                                        <label
                                            class="btn btn-light btn-sm btn-file py-2 mb-0 cursor-pointer border-left"
                                            title="select file"
                                        ...
                                        <button class="d-none btn btn-light btn-sm"
                                                ...
                                                @click="deleteImage('thumbnail',$parent.productData.product_image.thumbnail)"
                                                type="button">
                                            <i class="la la-trash"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="image w-one-third text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        <div v-else>
                                            <button v-if="$parent.productData.product_image.thumbnail"
                                                    class="btn bg-danger rounded-circle p-1 position-absolute e-0 cursor-pointer"
                                                    data-handle="remove"
                                                    style="width: 32px; height: 32px"
                                                    @click="deleteImage('thumbnail',$parent.productData.product_image.thumbnail)"
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mr-0 w-one-third my-auto">
                                    ...
                                    <small v-if="$parent.validationErrors.additional"
                                           class="text-danger mt-3">{{ $parent.validationErrors.additional[0] }}</small>
                                </div>
                                ...
                                <div class="w-one-third text-center px-3 my-auto">
                                    <div class="btn-group">
                                        <label
                                            ...
                                            <i class="la la-hand-pointer"></i>{{ titles.choose_file }}
                                            <input id="additional-image-browse" type="text"
                                                   class="form-control d-none file_design"
                                                   title="select file"
                                                   @click="processImagesByType('additional'); getImageBrowseModal(); canMultiple = true; browseAdditionalMedia($event)">
                                        </label>
                                        <label
                                            class="btn btn-light btn-sm btn-file py-2 mb-0 cursor-pointer border-left"
                                            title="select file"
                                            ...
                                            <i class="la la-cloud-upload-alt"></i>{{ titles.upload_file }}
                                            <input id="additional-image" type="file"
                                                   class="form-control d-none file_design"
                                                   title="select file"
                                                   @change="uploadAdditionalMedia">
                                        </label>
                                        <button class="btn btn-light btn-sm d-none"
                                                data-handle="remove"
                                                v-if="$parent.productData.product_image.additional && false"
                                                @click="deleteImage('additional',$parent.productData.product_image.additional)"
                                                type="button">
                                            <i class="la la-trash"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="image w-one-third text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        <div
                                            v-else-if="$parent.productData.product_image.additional && $parent.productData.product_image.additional.length > 0"
                ...
                <!-- Button to Open filemanager Modal -->
...
export default {
    ...
    methods: {
        removeSelectedFiles(index, length = 1) {
            let path = [];
            let fileIndex = this.$store.state.fm.left.selected.files.findIndex(file => {
                return file === this.$parent.selectedFiles[index].replace(process.env.MIX_AWS_URL, "");
            });

            if (fileIndex > -1) {
                path = this.$store.state.fm.left.selected.files.splice(index, length);
                if (!this.$store.state.fm.left.selected.files.length) this.$parent.selectedFiles = [];
            } else path = this.$parent.selectedFiles.splice(index, length);
        ...
        processImagesByType(type = 'main') {
            this.type = type;
            this.$parent.selectedFiles = this.$parent.productData.product_image[this.type];
        },
        ...
        deleteImage(type, url) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('/admin/product/remove_image', {url: url, product_id: product_id, type: type})
                        .then((res) => {
                            new Noty({
                                type: "success",
        ...
        sendDataToServer(base64, directory, local_url, type, product_code = null) {
            ...
            axios.post('/admin/product/upload_image', {image: base64, directory: directory, productCode: product_code})
                .then((res) => {
                    let imgLink = "/" + res.data;
                    if (type === "main")
                        this.$parent.productData.product_image.main = imgLink;
                    else if (type === "thumb")
                        this.$parent.productData.product_image.thumbnail = imgLink;
        ...
        uploadMainImage(event) {
            ...
            if (file.size > 3048770) {
                ...
                reader.onload = event => {
                    ...
                    this.sendDataToServer(base64image, this.image.main.directory, this.$parent.productData.image_url, "main", this.$parent.productData.product_code)
                }
        ...
        uploadThumbImage(event) {
            ...
            if (file.size > 3048770) {
                ...
                reader.onload = event => {
                    base64image = event.target.result;
                    this.sendDataToServer(base64image, this.image.thumb.directory, this.$parent.productData.thumbnail, "thumb", this.$parent.productData.product_code)
                }
                reader.readAsDataURL(file);
            }
        },
        ...
        uploadAdditionalMedia(event) {
            ...
            if (file.size > 3048770) {
                ...
                reader.onload = event => {
                    base64image = event.target.result;
                    this.sendDataToServer(base64image, this.image.additional.directory, this.$parent.productData.additional_image_urls, "additional", this.$parent.productData.product_code)
                }
                reader.readAsDataURL(file);
            }
        },
                    ...
                    if (self.canMultiple) {
                        ...
                        if (filesPath) {
                            self.$parent.selectedFiles = filesPath.map(filePath => {
                                return self.$store.state.fm.left.selectedDisk === "uploads" ? process.env.MIX_AWS_url + "/" + filePath : "/" + filePath;
                            })
                        }
                    } else {
                        ...
                        if (filePath) {
                            self.$parent.selectedFiles = self.$store.state.fm.left.selectedDisk === "uploads" ? process.env.MIX_AWS_url + "/" + filePath : "/" + filePath;
                        }
                    }
