...
use Amplify\System\Backend\Http\Requests\AttributeValueRequest;
use Amplify\System\Backend\Models\AttributeValue;
 ...
 */
class AttributeValueCrudController extends BackpackCustomCrudController
{
    use CreateOperation;
    use DeleteOperation;
    use ListOperation;
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('attribute_name');
        CRUD::field('attribute_value');
