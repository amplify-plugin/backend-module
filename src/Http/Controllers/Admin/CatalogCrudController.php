...
use Amplify\System\Backend\Http\Requests\CatalogRequest;
 ...
 */
class CatalogCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(\Amplify\System\Backend\Models\Catalog::class);
