...
use Amplify\System\Backend\Http\Requests\EmailRequest;
 ...
 */
class EmailCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(\Amplify\System\Backend\Models\Email::class);
