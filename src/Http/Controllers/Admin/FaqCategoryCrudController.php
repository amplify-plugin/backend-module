...
use Amplify\System\Backend\Http\Requests\FaqCategoryRequest;
 ...
 */
class FaqCategoryCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(\Amplify\System\Backend\Models\FaqCategory::class);
