...
use Amplify\System\Backend\Http\Requests\PaymentRequest;
 ...
 */
class PaymentCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(\Amplify\System\Backend\Models\Payment::class);
