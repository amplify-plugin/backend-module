...
use Amplify\System\Backend\Http\Requests\TaxRequest;
 ...
 */
class TaxCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(\Amplify\System\Backend\Models\Tax::class);
