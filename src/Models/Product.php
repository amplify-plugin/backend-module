...
class Product extends Model implements ContractsAuditable
{
    ...
    */
    ...
    public static function guessSingleProductDetail()
    {
        ...
        return Product::select('id', 'product_name', 'flags', 'has_sku', 'description', 'short_description', 'manufacturer_id', 'manufacturer',
            'single_product_page_id', 'sku_default_attributes', 'features', 'specifications', 'min_order_qty',
            'qty_interval', 'product_code', 'in_stock', 'is_ncnr', 'gtin_number', 'product_slug', 'manufacturer', 'sku_id')
    ...
    */
    ...
    {
        $sku_attributes = json_decode($this->sku_default_attributes) ?: [];
